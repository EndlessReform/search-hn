# Evaluation protocol and original run
...
Completed analyses: [final FTS findings](03-fts-findings.md),
[embedding and DuckDB hybrid baselines](04-embeddings.md), and
[ephemeral PG vs DuckDB bakeoff and trajectory replay](05-engine-bakeoff.md), plus
[Qwen3 reranker quality and batching](06-reranker.md).

Fresh paginated Luna dense/hybrid experiment: [setup and reproduction](07-semantic-luna.md).
...
remote. No code synchronization is needed for subsequent runs. The completed run
was started remotely before this clarification and remains archived at
...
completed data. All 588 terminal trajectories have been copied locally to
`data/fts-baseline-20260904/plain-results/`, and the reports regenerated.
