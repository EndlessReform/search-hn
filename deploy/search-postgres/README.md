...
This PG17.11 scratch image builds pgvector **0.8.6** and pg_textsearch **1.4.0**
...
Use the [rollout runbook](../../docs/search-rollout.md) for packaged production
installation. This Dockerfile's source build is only a scratch fixture; do not
copy its libraries to the production host. The canonical migration owns search
objects and service-role grants; no deployment-side grant script is needed.
